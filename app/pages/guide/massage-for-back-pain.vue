      ...
      <div class="max-w-4xl mx-auto space-y-12">
        <div v-for="section in sections" :key="section" class="bg-gray-50 rounded-2xl p-8 md:p-12">
          <h2 class="text-2xl md:text-3xl font-display text-gray-900 mb-4">
            {{ t(`guide.backPain.${section}.title`) }}
          </h2>
          <p class="text-lg text-gray-700 leading-relaxed">
            {{ t(`guide.backPain.${section}.description`) }}
          </p>
        </div>
...
useHead(() => ({
  ...
  meta: [
    { name: "description", content: t("guide.backPain.meta.description") },
    { property: "og:title", content: t("guide.backPain.meta.title") },
    { property: "og:description", content: t("guide.backPain.meta.description") },
    { property: "og:type", content: "article" },
    { property: "og:image", content: "https://olegmassage.com/images/og/championship-action.jpeg" },
  ],
  link: [
    { rel: "canonical", href: `https://olegmassage.com${localePath("/guide/massage-for-back-pain")}` },
  ],
}));
</script>
