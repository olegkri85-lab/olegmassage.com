    ...
    <section class="py-16 px-8 xl:py-32 xl:px-16 bg-[hsl(var(--accent-hsl))]">
      <div class="container mx-auto">
        ...
        <h1 class="text-5xl md:text-6xl lg:text-7xl font-display text-white mb-8">
          {{ t("guide.pregnancyMassage.title") }}
        </h1>
        <p class="text-lg md:text-xl text-white/90 leading-relaxed">
          {{ t("guide.pregnancyMassage.intro") }}
        </p>
      </div>
    </section>
      ...
      <div class="container mx-auto space-y-12">
        <div v-for="section in sections" :key="section" class="bg-gray-50 rounded-2xl p-8 md:p-12">
          <h2 class="text-2xl md:text-3xl font-display text-gray-900 mb-4">
            {{ t(`guide.pregnancyMassage.${section}.title`) }}
          </h2>
          <p class="text-lg text-gray-700 leading-relaxed">
            {{ t(`guide.pregnancyMassage.${section}.description`) }}
          </p>
        </div>
...
useHead(() => ({
  ...
  meta: [
    { name: "description", content: t("guide.pregnancyMassage.meta.description") },
    { property: "og:title", content: t("guide.pregnancyMassage.meta.title") },
    { property: "og:description", content: t("guide.pregnancyMassage.meta.description") },
    { property: "og:type", content: "article" },
    { property: "og:image", content: "https://olegmassage.com/images/og/championship-action.jpeg" },
  ],
  link: [
    { rel: "canonical", href: `https://olegmassage.com${localePath("/guide/massage-during-pregnancy")}` },
  ],
}));
</script>
