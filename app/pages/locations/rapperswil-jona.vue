    ...
    <section class="py-16 px-8 xl:py-32 xl:px-16 bg-[hsl(var(--accent-hsl))]">
      <div class="max-w-4xl">
        <p class="text-xs md:text-sm uppercase tracking-widest text-white mb-4">
          Mobile Massage in Rapperswil-Jona
        </p>
        ...
        <p class="text-lg md:text-xl text-white/90 leading-relaxed mb-8">
          Entspannungs-, Sport- und klassische Massage bei Ihnen zu Hause in Rapperswil-Jona und Umgebung.
        </p>
      ...
      <div class="max-w-4xl">
        ...
        <div class="bg-white rounded-2xl p-8 md:p-12 mb-12">
          <h3 class="text-2xl md:text-3xl font-display text-gray-900 mb-6">
            Warum mobile Massage in Rapperswil-Jona?
          </h3>
...
useHead(() => ({
  title: "Mobile Massage in Rapperswil-Jona | Sport-, klassische und Entspannungsmassage",
  meta: [
    { name: "description", content: "Mobile Massage in Rapperswil-Jona – Sportmassage, klassische Massage, Entspannungsmassage und Schröpfen. Jetzt per WhatsApp buchen." },
    { property: "og:title", content: "Mobile Massage in Rapperswil-Jona" },
    { property: "og:description", content: "Professionelle mobile Massage in Rapperswil-Jona. Jetzt Termin buchen." },
