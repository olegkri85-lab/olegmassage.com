      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-gray-50 rounded-2xl p-8 md:p-12 mb-16">
          ...
          <p class="text-lg text-gray-700 leading-relaxed">
            {{ t("servicePages.relaxation.whatToExpect.description") }}
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <ServiceCard
              ...
              :description="
                t('services.classical.description').substring(0, 150) + '...'
              "
          ...
          <NuxtLink :to="localePath('/services/cupping-massage')" class="group">
            <ServiceCard
