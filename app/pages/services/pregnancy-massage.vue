          ...
          <div class="lg:col-span-5">
            <div class="lg:sticky lg:top-8 space-y-6">
              ...
              <div class="space-y-3">
                ...
                <a
                  href="mailto:oleh.kryvorotko@icloud.com?subject=Pregnancy%20Massage"
        ...
        <div class="bg-white rounded-2xl p-8 md:p-12 mb-8">
          ...
          <ul class="space-y-4 text-lg text-gray-700">
            <li v-for="i in 4" :key="i" class="flex items-start gap-3">
              ...
              <span>{{ t(`servicePages.pregnancy.benefits.${i}`) }}</span>
            </li>
          </ul>
        </div>
...
useHead(() => ({
  ...
  meta: [
    ...
    { property: "og:type", content: "website" },
    {
      property: "og:image",
      content:
        "https://olegmassage.com/images/og/pregnancy-massage.jpeg",
    },
  ],
  link: [
    {
      ...
      children: JSON.stringify({
        ...
        offers: [
          ...
          },
          {
            ...
            price: "1020",
            priceCurrency: "CHF",
            description: `${t("services.pregnancy.title")} - 10x ${t(
              "services.duration.massage60"
            )} (${t("pricing.packages.badge")})`,
            availability: "https://schema.org/InStock",
          },
