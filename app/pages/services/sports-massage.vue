          ...
          <div class="lg:col-span-5">
            <div class="lg:sticky lg:top-8 space-y-6">
              ...
              <div class="bg-gray-50 rounded-2xl p-6">
                ...
                <div class="space-y-3">
                  <div class="flex items-center justify-between">
                    ...
                    <span class="text-2xl font-bold text-gray-900">140 CHF</span>
                  </div>
                </div>
              </div>
                ...
                <div class="space-y-3">
                  <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                      <span class="text-sm text-red-500 line-through">1400 CHF</span>
                      <span class="text-xl font-bold text-gray-900 ml-2">1190 CHF</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="space-y-3">
                ...
                <a
                  href="mailto:oleh.kryvorotko@icloud.com?subject=Sports%20Massage"
        ...
        <div class="bg-white rounded-2xl p-8 md:p-12 mb-8">
          ...
          <ul class="space-y-4 text-lg text-gray-700">
            <li v-for="i in 4" :key="i" class="flex items-start gap-3">
              ...
              <span>{{ t(`servicePages.sports.benefits.${i}`) }}</span>
            </li>
          </ul>
        </div>
