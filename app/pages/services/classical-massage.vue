<template>
  <div class="bg-gray-50">
          ...
          <div class="space-y-6">
            ...
            <ul class="space-y-4 text-lg text-gray-700">
              <li class="flex items-start gap-3">
                ...
                <span>{{ t("servicePages.classical.benefits.1") }}</span>
              </li>
              <li class="flex items-start gap-3">
                <span class="text-[hsl(var(--accent-hsl))] text-2xl">✓</span>
                <span>{{ t("servicePages.classical.benefits.2") }}</span>
              </li>
              <li class="flex items-start gap-3">
                <span class="text-[hsl(var(--accent-hsl))] text-2xl">✓</span>
                <span>{{ t("servicePages.classical.benefits.3") }}</span>
              </li>
              <li class="flex items-start gap-3">
                <span class="text-[hsl(var(--accent-hsl))] text-2xl">✓</span>
                <span>{{ t("servicePages.classical.benefits.4") }}</span>
              </li>
            </ul>
          </div>
        </div>
    ...
    <section class="py-16 px-8 xl:py-32 xl:px-16 bg-white">
      <div class="container mx-auto">
        <ServicePackage service-key="classical" />
      </div>
    </section>
