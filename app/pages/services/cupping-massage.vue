        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div>
            <ImagePlaceholder
              ...
              :label="t('services.cupping.title')"
            />
          </div>
          <div class="space-y-6">
...
useHead(() => ({
  ...
  meta: [
    {
      name: "description",
      content: t("servicePages.cupping.meta.description"),
    },
    { property: "og:title", content: t("servicePages.cupping.meta.title") },
    {
    ...
    { property: "og:type", content: "website" },
    {
      property: "og:image",
      content:
        "https://olegmassage.com/images/services/large/cupping-therapy.jpeg",
    },
  ],
  link: [
    {
