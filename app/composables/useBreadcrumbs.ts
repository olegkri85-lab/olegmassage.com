  ...
  const breadcrumbSchema = computed(() => {
    ...
    if (path.includes("/locations")) {
      const locationMap: Record<string, string> = {
        ...
        "kreis-1": "location.kreis1.title",
        "kreis-2": "location.kreis2.title",
        "kreis-3": "location.kreis3.title",
        "kreis-4": "location.kreis4.title",
        "kreis-5": "location.kreis5.title",
        "kreis-6": "location.kreis6.title",
        "kreis-7": "location.kreis7.title",
        "kreis-8": "location.kreis8.title",
        "kreis-9": "location.kreis9.title",
        "kreis-10": "location.kreis10.title",
        "kreis-11": "location.kreis11.title",
        "kreis-12": "location.kreis12.title",
        maennedorf: "location.maennedorf.title",
        uetikon: "location.uetikon.title",
        oetwil: "location.oetwil.title",
        richterswil: "location.richterswil.title",
        wollerau: "location.wollerau.title",
        freienbach: "location.freienbach.title",
        pfaeffikon: "location.pfaeffikon.title",
        au: "location.au.title",
      };
